...
public class CmsAppDataSeedContributor :IDataSeedContributor, ITransientDependency
{
    ...
    public CmsAppDataSeedContributor(IdentityUserManager userManager, IConfiguration configuration)
    {
