...
public class CmsAppUserIdResolver : ITransientDependency
{
    private const string DemoUserCookieName = "CmsAppUser";

    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IGuidGenerator _guidGenerator;

    public CmsAppUserIdResolver(IHttpContextAccessor httpContextAccessor, IGuidGenerator guidGenerator)
    {
